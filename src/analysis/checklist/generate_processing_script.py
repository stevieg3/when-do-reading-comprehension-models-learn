...
for seed in SEEDS:
    for checkpoint in SAVE_STEPS_SCHEDULE:
        flatten_commands.append(
            f"python src/analysis/checklist/flatten_squad_predictions.py '/SAN/intelsys/rclearn/when-do-reading-comprehension-models-learn/predictions/checklist/albert-xlarge-v2-squadv1-adversarialall-wu=100-lr=3e5-bs=32-msl=384-seed={seed}/checkpoint-{checkpoint}/predict_predictions.json'"
        )
        ...
        extract_commands.append(
            f"python src/analysis/checklist/extract_results_from_checklist_summary.py '/SAN/intelsys/rclearn/when-do-reading-comprehension-models-learn/predictions/checklist/albert-xlarge-v2-squadv1-adversarialall-wu=100-lr=3e5-bs=32-msl=384-seed={seed}/checkpoint-{checkpoint}/checklist_results.txt'"
        )
