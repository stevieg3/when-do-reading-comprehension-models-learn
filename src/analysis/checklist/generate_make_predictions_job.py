...
for checkpoint in SAVE_STEPS_SCHEDULE:
    this_commands = [
        ...
        f"--model_name_or_path /SAN/intelsys/rclearn/when-do-reading-comprehension-models-learn/models/albert-xlarge-v2-squadv1-wu=100-lr=3e5-bs=32-msl=384-seed=28/checkpoint-{checkpoint} "
        f"--do_predict "
        ...
        f"--output_dir /SAN/intelsys/rclearn/when-do-reading-comprehension-models-learn/predictions/checklist/albert-xlarge-v2-squadv1-wu=100-lr=3e5-bs=32-msl=384-seed=28/checkpoint-{checkpoint} "
        f"--overwrite_output_dir "
        f"--overwrite_cache "
        f"--report_to none "
        f"> logs/checklist/albert-xlarge-v2-squadv1-wu=100-lr=3e5-bs=32-msl=384-seed=28-checkpoint={checkpoint}.log 2>&1"
    ]
...
export TRANSFORMERS_CACHE=/SAN/intelsys/rclearn/cache
